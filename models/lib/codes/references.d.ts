export declare enum MedicationClassReference {
...
export declare enum MedicationReference {
...
export declare enum DrugReference {
...
export declare enum QuestionnaireReference {
    enUS = "questionnaires/0"
}
export declare enum VideoReference {
