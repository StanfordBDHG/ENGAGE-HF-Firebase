...
export function symptomQuestionnaireLinkIds(questionnaireUrl) {
    var linkIds = linkIdMap.get(questionnaireUrl);
    if (!linkIds)
        throw new Error("Unknown questionnaire ".concat(questionnaireUrl, "."));
    return linkIds;
}
